...
def generate_hr_questions(request: Request):
    ...
    prompt = (
        f"Generate 5 realistic technical interview questions that test the following skills: "
        f"{', '.join(technical_skills)}. "
        f"Use clear and practical language, and focus on problem-solving or hands-on application. "
        f"Avoid overly theoretical or abstract phrasing, but ensure each question directly evaluates one of the listed skills."
